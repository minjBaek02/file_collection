...
본 프로젝트의 목적은 80개의 *Lactobacillus fermentum* 전체 유전체 데이터를 기반으로 **pan-genome 분석**을 수행하고, 특히 **accessory gene 기반의 클러스터링을 통해 phylogroup을 정의할 수 있는지 탐색**하는 것이다. 이를 위해 Roary, EggNOG-mapper 등의 도구를 활용하여 유전자의 보존 양상, 기능적 카테고리, 각 그룹의 기능적 특성 등을 분석하였다.
...
직접적으로 orthology(직계 상동성) 정보를 활용해 유전자의 기능, COG 카테고리, 효소 기능, 대사 경로 정보를 자동으로 부여하며 대규모 microbiome 또는 비교유전체 분석에서 널리 사용된다. 이 도구를 통해 각 유전자의 faa파일로 'egg-nog_result.tabular' 유전자들의 기능 정보가 담긴 파일을 생산했다.
이 중에서, accessory_gene_에 해당하는 정보들만 추출했다.
...
- `gene_presence_absence.csv` (파일이 커 드라이브로 공유)
https://drive.google.com/file/d/1EDG4GOAYZXRJQgU3JVVb_FgLZXYKjNdR/view?usp=sharing

- `accessory_genes.list`  
 https://github.com/minjBaek02/file_collection/blob/f2a3142104dd18edf193c064c20cf763b9f31402/%EA%B9%83%ED%97%88%EB%B8%8C%20%EC%97%85%EB%A1%9C%EB%93%9C%20%ED%8C%8C%EC%9D%BC/accessory_genes.list  
...
- 'egg-nog_result.tabular'
https://drive.google.com/file/d/1QG7--Y-G5xNm89FKU1c2Bf3uvwBT9V7K/view?usp=sharing

- `accessory_eggnog_annotations.tsv`  
...
https://github.com/minjBaek02/file_collection/blob/0b7c22255b10ec99ac4f9b1f09426cddd0129580/%EA%B9%83%ED%97%88%EB%B8%8C%20%EC%97%85%EB%A1%9C%EB%93%9C%20%ED%8C%8C%EC%9D%BC/genome_cog_category_counts.tsv
...
- `biosample_metadata_81_sort.csv`
https://github.com/minjBaek02/file_collection/blob/0b7c22255b10ec99ac4f9b1f09426cddd0129580/%EA%B9%83%ED%97%88%EB%B8%8C%20%EC%97%85%EB%A1%9C%EB%93%9C%20%ED%8C%8C%EC%9D%BC/biosample_metadata_81_sort.csv
